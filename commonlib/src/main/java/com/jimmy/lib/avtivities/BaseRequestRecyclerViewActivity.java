...
import com.jimmy.lib.widgets.WrapRecyclerView;
...
public abstract class BaseRequestRecyclerViewActivity extends BaseRequestActivity implements AdapterView.OnItemClickListener, QMUIPullRefreshLayout.OnPullListener, ListView.OnScrollListener {
    ...
    protected WrapRecyclerView getRecyclerView() {
...
//        mRecyclerView.setDivider(drawable);
//        mRecyclerView.setDividerHeight(heightPx);
    }
