...
import com.jimmy.lib.utils.CollectionUtils;
import com.jimmy.lib.utils.LogUtils;
import com.jimmy.lib.utils.StringUtils;
import com.jimmy.lib.widgets.FooterView;
 ...
 */
public abstract class BaseRequestListViewFragment extends BaseRequestFragment implements AdapterView.OnItemClickListener, QMUIPullRefreshLayout.OnPullListener, ListView.OnScrollListener {
    ...
    protected void initViewEvents() {
        mPtrLayout = ButterKnife.findById(getActivity(), R.id.meituan_ptr_layout);
        mListView = ButterKnife.findById(getActivity(), R.id.list_view);
        mFooterView = new FooterView(getActivity());
        mListView.setOnItemClickListener(this);
        mListView.setOverScrollMode(View.OVER_SCROLL_NEVER);
        mListView.setDividerHeight(0);
        mPtrLayout.setOnPullListener(this);
//        mListView.setOnScrollListener(new PauseOnScrollListener(YjlImageLoader.getInstance(), true, true, this));
    }
...
//            return mPtrLayout.isRefreshing();
    ...
    protected void setListViewDivider(ListView listView) {
        listView.setDivider(new ColorDrawable(ContextCompat.getColor(mActivity, R.color.divider)));
